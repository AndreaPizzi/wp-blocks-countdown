// Register a Count Down block
 if( function_exists('acf_register_block') ) {
     
  $result = acf_register_block(array(
      'name'              => 'nt_countdown_block', // Name of our block
      'title'             => __('NTNext - Countdown Block'), // Title of our block
      'description'       => __('Block for an horizontal countdown.'), // Description of our block
